...
class Testxyp_dot_size(unittest.TestCase):
    ...
    def test_dot_size_is_none(self):
        self.p2s.xyp(self.df, 'a', 'b', dot_size=None)
        self.p2s.xyp(self.df, ['a','b'], ['c','d'], dot_size=None)

    def test_dot_size_is_int(self):
        self.p2s.xyp(self.df, 'a', 'b', dot_size=1)
        self.p2s.xyp(self.df, 'a', 'b', dot_size=2)
        self.p2s.xyp(self.df, 'a', 'b', dot_size=10)
        self.p2s.xyp(self.df, ['a','b'], ['c','d'], dot_size=2)

    def test_dot_size_is_float(self):
        self.p2s.xyp(self.df, 'a', 'b', dot_size=0.1)
        self.p2s.xyp(self.df, 'a', 'b', dot_size=1.0)
        self.p2s.xyp(self.df, 'a', 'b', dot_size=2.0)
        self.p2s.xyp(self.df, 'a', 'b', dot_size=10.0)
        self.p2s.xyp(self.df, ['a','b'], ['c','d'], dot_size=2.0)

    def test_dot_size_is_int_list(self):
        self.p2s.xyp(self.df, ['a','b'], ['c','d'], dot_size=[1,2])
        self.p2s.xyp(self.df, ['a','b'], ['c','d'], dot_size=[5,5])

    def test_dot_size_is_float_list(self):
        self.p2s.xyp(self.df, ['a','b'], ['c','d'], dot_size=[1.0,2.0])
        self.p2s.xyp(self.df, ['a','b'], ['c','d'], dot_size=[5.0,5.0])
